...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
        "inline-flex h-12 items-center justify-center rounded-xl bg-slate-800 text-white border border-slate-600",
        className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
        ...
        "text-slate-300 hover:text-white hover:bg-slate-700",      className
    )}
    {...props}
  />
))
